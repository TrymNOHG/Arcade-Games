...
public class Sudoku extends JPanel implements Runnable{
    ...
    protected void paintComponent(Graphics g){
        ...
        SudokuGraphics sGame = new SudokuGraphics();
        sGame.genWholeBoard(this.sudokuWindow.getHeight(), this.sudokuWindow.getWidth(), this.boardLength, graphics2D, timer, timePlayed, this.sBoard.getUnfinishedBoard(), this.sudokuWindow);
        this.add(timer);
        //graphics2D.dispose();
    }
